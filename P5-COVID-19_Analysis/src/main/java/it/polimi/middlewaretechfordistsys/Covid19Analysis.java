...
public class Covid19Analysis {
    ...
    public static void main(String[] args) {
        ...
        // TASK 1
        Dataset<Row> df = spark.read().format("csv").option("header", "true").option("inferSchema", true).load(filePath + "resources/csv/ecdc/data.csv");
        WindowSpec ws1 = Window.partitionBy("countriesAndTerritories").orderBy("date", "geoId").rowsBetween(-6,0);
        ...
        // TASK 2
        WindowSpec ws2 = Window.partitionBy("countriesAndTerritories").orderBy("date", "geoId");
        ...
        Dataset<Row> df5 = df4.where("rankingPercIncrease<=10").orderBy("date", "rankingPercIncrease");
