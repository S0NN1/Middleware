package it.polimi.middlewaretechfordistsys.old;
...
import it.polimi.middlewaretechfordistsys.old.model.Schema;
import it.polimi.middlewaretechfordistsys.old.utils.CalculateUtils;
import it.polimi.middlewaretechfordistsys.old.utils.PrintUtils;
...
final class Covid19CaseCount {
    ...
    public static void main(String[] args) {
        ...
        StructType mySchema = Schema.getSchema();
